  ...
  <main role="main">
    <div class="main-content-container home">
      <div id="pageHeaderCarousel" class="carousel slide bg-fss" data-ride="carousel" data-interval="false">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img class="carousel-img centered" width="2000" height="600" img src="img/index/slider_wms_02.jpg" alt="carousel-image">
            <div class="container">
              <div class="carousel-caption text-center">
                ...
                <meta name="google-site-verification" content="dHMFqDXe618xGFGEOIpNiSdZY_I3frZG1isyx4CM5_Q" />
                 <h2><p>Yüksek teknoloji, esnek mimari ve her ölçekte ideal performans</p></h2>
          ...
          <div class="carousel-item">
            <img class="carousel-img" width="2000" height="600" src="img/index/warehouse.jpg" alt="carousel-image">
            <div class="container">
          ...
          <div class="carousel-item">
            <img class="carousel-img left-n20" width="2000" height="600" src="img/index/wms-depo-yönetimi-cloud.png" alt="index">
            <div class="container">
              <div class="carousel-caption">
                <img class="fss-decorative-squares" src="img/fss-decor-light.svg" alt="fss-decor">
      ...
      <div class="container-fluid solutions-section">
          ...
          <div class="row solution-card decorative">
            <div class="col-md-6 solution-card-body">
              <h4 class="featurette-heading">
                <img class="fss-decorative-squares" src="img/fss-decor-light.svg" alt="fss-decor">
                <a href="wms.aspx" alt="index">
                  <span class="fss-title">FSMobility-Depo Yönetim Sistemi (WMS)</span></a>
                  ...
                  <h4<span class="sub-heading">Depo Yönetim Sistemi Çözümünüz</span></h4>
              </h3>
              <div class="lead">
                <p>FSSoftware 200+ proje deneyimi ile depo yönetim sistemi ihtiyaçlarınız için esnek, sürdürülebilir bir depo yönetim sistemi yazılım çözümü sunmaktadır.</p>
            ...
            <div class="col-md-6 solution-card-body">
              <h3 class="featurette-heading">
                ...
                <a href="ket.aspx" alt="index">
                  <span class="fss-title">FSMobility-Kırmızı Et Çözümü</span></a>
              ...
              <div class="lead">
                <p>FSMobility Kırmızı Et İzlenebilirliğinde EAN ve RFID etiketleri ile birlikte dünya standartlarında ve üst düzeyde izlenebilirlik sağlamaktadır.</p>
       ...
       <div class="container scroll-triggered-anim fade-in-animation">
          <div class="row solution-card decorative">
            <div class="col-md-6 solution-card-body">
              <h3 class="featurette-heading">
                <img class="fss-decorative-squares"width="640" height="360" src="img/fss-decor-light.svg" alt="fss-decor">
      ...
      <div class="container-fluid heading-section success-heading-section">
        <h4 class="heading"><span class="fa fa-check mr-1 my-auto small"></span>Başarı Öyküleri</h4>
      </div>
      ...
      <div class="container-fluid heading-section partner-heading-section">
        <h4 class="heading d-flex"><span class="fa fa-handshake mr-1 my-auto bigger"></span>Çözüm Ortaklarımız</h4>
      </div>
      ...
      <div class="container-fluid blog scroll-triggered-anim">
        <div class="container">
          ...
          <div class="card-deck">
            <div class="card">
              <img src="img/index/depo-yonetim-sistemleri.jpg" class="card-img-top" alt="index">
            ...
            <div class="card">
               <img src="img/index/tedarik-zinciri-yönetimi.jpg"  alt="index">
              <!-- Resimler Ölçekli Olmalı Örnek: 16x9, 4x3 vs -->
              <div class="card-body">
            ...
            <div class="card">
              <img src="img/index/yazılım_teknolojisi.jpg" class="card-img-top" alt="index"> 
              <!-- Resimler Ölçekli Olmalı Örnek: 16x9, 4x3 vs -->
              <div class="card-body">
      ...
      <div class="container-fluid heading-section solution-heading-section">
        <h4 class="heading d-flex"><img class="fss-decorative-squares" src="img/fss-decor-white.svg" alt="fss-decor">Basında Biz</h4>
          </div>
        </div>
      </div>
      <div class="container-fluid blog scroll-triggered-anim">
        ...
        <div class="card-deck">
          < <div class="card">
           <img class="lazy" src="img/index/bilisimbesyuz.jpg" alt="img">
            <!-- Resimler Ölçekli Olmalı Örnek: 16x9, 4x3 vs -->
            <div class="card-body">
          ...
          <div class="card">
              <img class="lazy" src="img/index/dijital-etkinlik-savunma-sanayi.jpg" alt="img">
              <!-- Resimler Ölçekli Olmalı Örnek: 16x9, 4x3 vs -->
              <div class="card-body">
          ...
          <div class="card">
            <img class="lazy" src="img/index/makfed-dijital-etkinlik.jpg" alt="img">
            <!-- Resimler Ölçekli Olmalı Örnek: 16x9, 4x3 vs -->
            <div class="card-body">
            <a href="makfeddijitaletkinlik.aspx" alt="index">
