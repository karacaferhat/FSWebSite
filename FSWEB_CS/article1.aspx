            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12 col-lg-8">
                        <h1 class="text-orange font-black">FSSoftware Tübitak Desteği ile Yeni Versiyonu FSStockChain'i Ürününü Geliştirdi! </h1>
                        <p>FSSoftware, yeni versiyonu  FSStockChain ile kurumsal yazılım platform hedeflerini bireysel mobil ve sosyal medya alışkanlıklarının birleştiği güncel bir platform olmayı tercih ederek Android ve iOS üzerinde çalıştırılabilen ürün ailesi geliştirmiştir.</p>
                        ...
                        <p>İleriye dönük teknolojik değişimleri doğru zamanda karşılamak, hızlı reaksiyon vererek müşterilerine en güncel teknolojileri sunabilmek adına Back-End ve Front-End tarafında bağımsız ve modüler bir mimari kullanılmıştır.Güvenlik altyapısı OAUTH 2 ve SSL mimarisi ile güçlendirilmiş, yayınlama platformları Google  Play ve App Store platformlarına taşınmıştır. Sistem bakım gereksinimleri Azure Bulut hizmetleri içerisinde pratik ve hızlı bir çözüme kavuşmuştur.
                        <p>FSSoftware sıkça yön değiştiren rüzgarlara karşı öngörülere dayanarak değil, hızlı adapte olabilme yeteneğimizi geliştiren yol haritası çıkarılmış ve değişimleri müşterilerimizin seçeneklerini zenginleştirmek üzerine bir vizyona dayandırmayı tercih etmiştir.</p>
                        </div>
                    <div class="col-lg-2"></div>
                </div>
            </div>
