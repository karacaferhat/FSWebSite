<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="basin.aspx.cs" Inherits="FSWEB_CS.basin" %>
    ...
    <div class="container-fluid blog scroll-triggered-anim">
      <div class="container">
        ...
        <div class="card-deck">
          ...
          <div class="card">
            <img src="img/index/lojitv-wmseğitimi-kapak.png" class="card-img-top" alt="...">
            <!-- Resimler Ölçekli Olmalı Örnek: 16x9, 4x3 vs -->
            <div class="card-body">
          ...
          <div class="card">
           <img src="img/index/vision2021-kapak.png" class="card-img-top alt="...">
            <!-- Resimler Ölçekli Olmalı Örnek: 16x9, 4x3 vs -->
            <div class="card-body">
              <h5 class="card-title text-fss font-weight-bold">Vision 2021</h5>
